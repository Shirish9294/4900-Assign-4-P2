    ...
    <div class="row align-items-center justify-content-center">
      <div class="d-md-none" id="collapsable-card" style="width: 80%">
        <button type="button" class="btn btn-primary" @click="addNewStock"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#0275d8" class="bi bi-plus-circle-fill"
               viewBox="0 0 16 16">
            <path
        ...
        <div class="card" v-for="stock in stocks" v-bind:key="stock">
          <div class="card-header" :id="'heading' + stock.pk">
            <button class="btn btn-link collapsed" data-bs-toggle="collapse"
              ...
              <h6 style="color: #0275d8; float: left">Customer {{ stock.cust_number }} - {{ stock.symbol }}
                stock</h6>
            </button>
          </div>
          ...
          <div :id="'collapse' + stock.pk" class="collapse" :aria-labelledby="'heading' + stock.pk"
            ...
            <div class="card-body">
              ...
              <p><b>Acquired Value:</b> {{ stock.shares }}</p>
              <p><b>Acquired Date:</b> {{ stock.purchase_price }}</p>
              <p><b>Recent Value:</b> {{ stock.purchase_date }}</p>
              <div class="btn-group">
