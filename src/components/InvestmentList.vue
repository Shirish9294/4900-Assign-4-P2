        ...
        <div class="card" v-for="investment in investments" v-bind:key="investment">
          <div class="card-header" :id="'heading' + investment.pk">
            <button class="btn btn-link collapsed" data-bs-toggle="collapse"
              ...
              <h6 style="color: #0275d8; float: left">Customer {{ investment.cust_number }} - {{ investment.category }}
                investment</h6>
            </button>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="btn-group">
                ...
                <button @click="deleteInvestment(investment)" style="background-color: transparent; padding: 0;">
                  <svg @click="deleteInvestment" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
